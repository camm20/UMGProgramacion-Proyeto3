 ...
 * @author cesar
 */
@WebServlet(name = "addClienteIndividual", urlPatterns = {"/agregarclienteindividual"})
public class addClienteIndividual extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Individual individual = new Individual(_nombres, _apellidos, _direccion, _departamento, _dpi);
        ControladorClientes cliController = new ControladorClientes();
        if(cliController.addClienteIndividual(individual)){
            response.getWriter().print(cliController.getClienteIndividual());
        }else{
